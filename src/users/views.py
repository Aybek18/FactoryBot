...
from users.services import FernetService, UserAuthService
...
class UserRegistrationAPIView(CreateAPIView):
    ...
    @extend_schema(
        responses={
            201: OpenApiResponse(description='{"access_token": "Your access Token"}')
        }
    )
    def post(self, request, *args, **kwargs):
        ...
        return Response(
            data={"access_token": access_token}, status=status.HTTP_201_CREATED
        )
